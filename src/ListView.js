...
let dataList = [
  new TodoModel('Go to Luckys'),
  new TodoModel('Eat Sushi'),
  new TodoModel('Watch bigfoot doc'),
  new TodoModel('Call George RR Martin'),
  new TodoModel('Go to Oskar Blues'),
  new TodoModel('Watch KC Chiefs')
];
